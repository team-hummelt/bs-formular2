...
class Bs_Formular2 {
	...
	public function __construct() {
		if ( defined( 'BS_FORMULAR2_VERSION' ) ) {
			$this->version = BS_FORMULAR2_VERSION;
		} else {
			$this->version = '1.0.0';
		}
	...
	private function define_admin_hooks() {
		...
		$plugin_admin = new Bs_Formular2_Admin( $this->get_plugin_name(), $this->get_version() );
	...
	private function define_public_hooks() {
		...
		$plugin_public = new Bs_Formular2_Public( $this->get_plugin_name(), $this->get_version() );
