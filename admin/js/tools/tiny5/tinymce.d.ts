...
interface WindowManager {
    open: <T>(config: { initialData: { catdata: string, isdog: boolean }, buttons: [{ name: string, text: string, type: string }, { tooltip: string, disabled: boolean, id: string, text: string, type: string, primary: boolean }], onSubmit: dialogConfig.onSubmit, title: string, body: { type: string, items: [{ name: string, label: string, type: string }, { html: string, type: string }, { name: string, disabled: boolean, label: string, type: string, items: [{ text: string, value: string }, { text: string, value: string }, { text: string, value: string }, { text: string, value: string }, { text: string, value: string }] }, { name: string, disabled: boolean, label: string, type: string }, { maximized: boolean, name: string, disabled: boolean, label: string, placeholder: string, type: string }, null] } }, params?: WindowParams) => DialogInstanceApi<T>;
